...
public class CableObject : MonoBehaviour
{
    ...
    private Rigidbody2D startObjRigidBody;
    [SerializeField] GameObject EndObj = null;

    [SerializeField] private float StartPosY = 5f;
    //糸一単位の重さ
    ...
    void Start()
    {
        ...
        startObjRigidBody = StartObj.GetComponent<Rigidbody2D>();
        //開始時点で糸を出す
    ...
    public void SlowlyReel()
    {
        ...
        {
            startObjRigidBody.AddForce(new Vector2(0, ReelPower * Time.deltaTime));
        }
    }
